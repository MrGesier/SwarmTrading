...
import {useChartWindow, WindowControls} from './chart-controls';

export function MultiScale({state,horizon,context}:{state:State;horizon:number;context:string}){
 const view=useChartWindow(state.history.map(h=>h.time));

...
export const explanations: Record<string, string> = {
  ...
  "Price & trigger zones":
    "Bougies source de cinq secondes, regroupables en 15 s, 30 s, 1 min ou 5 min. La période affichée, la durée des bougies et l’horizon de stratégie sont indépendants. Le zoom et le verrouillage règlent seulement l’affichage. Les bandes indiquent des niveaux hypothétiques où le poids des stratégies change de direction. Ce sont des sensibilités du modèle, pas des ordres réels du marché.",
  "Liquidity landscape":
